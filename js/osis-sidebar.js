// =========================================================================
// OSIS SIDEBAR - drawer kiri (folder /osis/*). Disuntik otomatis.
...
const OsisSidebar = {
  ...
  DEFAULT_MENU: [
    ...
    { href: "absensi", label: "Absensi", icon: "fa-solid fa-clipboard-user" },
    { href: "tabungan", label: "Tabungan", icon: "fa-solid fa-piggy-bank" },
    ...
    { href: "poster", label: "Poster", icon: "fa-solid fa-newspaper" },
  ...
  MENU: [
    ...
    ["poster", "Poster", "fa-solid fa-newspaper"],
